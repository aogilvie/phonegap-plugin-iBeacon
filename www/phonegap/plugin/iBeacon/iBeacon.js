    ...
    IBeacon.prototype.addBeacons = function (beacons, success, failure) {
        exec(success, failure, "iBeacon", "addBeacons", [beacons]);
    };

    IBeacon.prototype.removeBeacons = function (beacons, success, failure) {
        exec(success, failure, "iBeacon", "removeBeacons", [beacons]);
    };
